  ...
  return (
    <main>
      ...
      <section className="mx-auto w-[min(94vw,1500px)] pb-16 pt-8">
        <p className="text-sm font-bold uppercase tracking-widest text-primary">Products</p>
      ...
      <section className="mx-auto grid w-[min(94vw,1500px)] gap-6 pb-20 lg:grid-cols-3">
        {products.map((product) => {
          ...
          return (
            <Card key={product.slug} id={product.slug} className="scroll-mt-8 p-7">
      ...
      <section className="border-y-2 border-border bg-[#f4f0ff] py-20">
        <div className="mx-auto w-[min(94vw,1500px)]">
          ...
          <h2 className="mt-4 max-w-4xl text-5xl font-bold uppercase leading-none md:text-7xl">
